// Add Subcontractor modal: simple form to add a sub to the crew roster.
// Fields: name, trade, phone, email, notes, star rating.
...
import { createSubcontractor } from '../lib/data';

// Trade options (same list used in crew.tsx)
const TRADE_OPTIONS = [
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.subheading}>Add a new sub to your crew roster.</Text>

        {/* Form card — Company Name first (most important for subs) */}
        <View style={styles.card}>
          {/* Company Name — at top as requested */}
...
const styles = StyleSheet.create({
  ...
  inputRow: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: BNG_COLORS.background,
    borderRadius: 10, borderWidth: 1, borderColor: BNG_COLORS.border, paddingHorizontal: 12,
  },
  ...
  textArea: {
    ...
    borderColor: BNG_COLORS.border, padding: 12, fontSize: 15, color: BNG_COLORS.text,
    minHeight: 80, textAlignVertical: 'top',
  },
  saveBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10,
    backgroundColor: BNG_COLORS.primary, paddingVertical: 14, borderRadius: 12,
    marginTop: 24, ...SHADOWS.glowPrimary,
  },
